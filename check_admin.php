						...
						<table class="table table-striped">
						  <thead>
							...
							<div class='dropdown-menu'>
								...
								<a class='dropdown-item' href='check.php'>Birime Göre Filitreleme</a>
								<div class='dropdown-divider'></div>
								<a class='dropdown-item' href='decline.php'>Reddedilen Talepler </a>
								<div class='dropdown-divider'></div>
								<a class='dropdown-item' href='decline.php'>İade Edilen Talepler </a>
								<div class='dropdown-divider'></div>
                        ...
                        $result = pg_query($dbconn, "SELECT * FROM public.product");
							...
							<?php
							 ...
							 for($i=0; $i <$last2; $i++){
								...
								if( (int)$state_onay==0 && (int)$state_req==1){
                                  echo "<tr>
							  <td>$count</td>  
						      <td>$cat</td>
						      <td>$un</td>
...
<script>
	...
	{
		if(confirm("Talebi reddetmek istediğinize emin misiniz?")==true){
		$.ajax({
			url: 'deneme.php',
			type: 'post',
